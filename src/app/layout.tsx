...
export const metadata: Metadata = {
  title: "Arbuz - AI PWA App & Ad Banner Generator for Traffic Arbitrage",
  description: "Generate PWA apps and high-converting ad banners in seconds using AI credits. Scale your arbitrage business instantly. 14-day free trial, no credit card required.",
  keywords: "traffic arbitrage, PWA generator, ad banner creator, arbitrage tools, AI marketing",
  ...
  openGraph: {
    title: "Arbuz - AI-Powered Traffic Arbitrage Platform",
    description: "Create offer-based PWA apps and ad banners in seconds. Join 5,000+ arbitrageurs scaling their campaigns with AI.",
    type: "website",
    siteName: "Arbuz",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763729812143-o1e9mrzy.jpg",
      alt: "Arbuz AI Dashboard"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Arbuz - AI Traffic Arbitrage Tool",
    description: "Generate PWA apps & ad banners instantly with AI. Start free today.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1763729812143-o1e9mrzy.jpg"]
  }
};
